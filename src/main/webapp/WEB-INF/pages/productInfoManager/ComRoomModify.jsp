...
<div id="maindiv">
    ...
    <form id="modifyform" class="form-horizontal" action="${pageContext.request.contextPath}/updateCommodityHouse" method="post"
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                ...
                <input type="file" class="form-control" onchange="changepic(this)" id="comimg" accept="image/png,image/jpeg" name="file_comImg" placeholder="请选择二手房图片">
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <input name="comPrice" id="comPrice" onkeyup="if( ! /^\d*(?:\.\d{0,2})?$/.test(this.value)){alert('只能输入数字，小数点后只能保留两位');this.value='';}" placeholder="价格" class="form-control" required>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <input name="comNumber" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" placeholder="房产数量" id="comNumber" type="text" class="form-control" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <input name="comColnum"  id="comColnum" readonly="readonly" class="form-control" >
            </div>
        </div>
