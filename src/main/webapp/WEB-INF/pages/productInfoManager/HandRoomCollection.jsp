...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#colName").val(eachBean.handName);
            //$("#aName").val(aname);
            $("#colImg").val(eachBean.handImg);

            $("#houseName").val(eachBean.handName);
            $("#pNameforh").val(eachBean.pName);
            $("#houseImg").val(eachBean.handImg);
            $("#price").val(eachBean.handPrice);
...
<%--          enctype="multipart/form-data">--%>
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                二手房姓名:<input name="handName" id="handName" readonly="readonly" class="form-control" >
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
                二手房价格：<input name="handPrice" id="handPrice" readonly="readonly" class="form-control" >
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                二手房地址：<input name="handAddress" readonly="readonly" id="handAddress" type="text"  class="form-control" >
            </div>
        </div>

        <div class="form-group row">
            <div class="col-sm-12">
                二手房数量：<input name="handNumber" readonly="readonly" id="handNumber" type="text" class="form-control">
            </div>
        </div>

        <div class="form-group row">
            <div class="col-sm-12">
                房龄：<input name="handAge" readonly="readonly" id="handAge" type="text" class="form-control">
            </div>
        </div>

        <div class="form-group row">
            <div class="col-sm-12">
                简介：<textarea name="handDescribe" readonly="readonly" id="handDescribe" rows=”3” class="form-control" cols=”10” style="resize: none"></textarea>
            </div>
        </div>

    <div class="form-group row">
        <div class="col-sm-12">
                 收藏量：<input name="handColnum"  id="handColnum" readonly="readonly"  class="form-control" >
        </div>
    </div>
<%--    </form>--%>
        ...
        <form id="modifyform1" class="form-horizontal" action="${pageContext.request.contextPath}/saveHandCollection" method="post"
              enctype="multipart/form-data">
