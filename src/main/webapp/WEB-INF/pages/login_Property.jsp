            ...
            <div class="row">
                <div class="col-sm-6 auth-box">
                    <div class="lochana-box-shadow">
                        <h3 class="widget-title">合作商家登录</h3>
                        <form action="${pageContext.request.contextPath}/login_Property" method="post" class="widget-form">
                            <!-- form-group -->
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <input type="text" name="pName" placeholder="用户名" class="form-control" required="" data-validation="length alphanumeric" data-validation-length="3-12"
...
<%--                                <small>新用户，您好！请在这里--%>
<%--                                    <a href="${pageContext.request.contextPath}/into_Property2">注册</a> Here</small>--%>
<%--                            </div>--%>
<%--                            <!-- /Links -->--%>
                        </form>
                    </div>
